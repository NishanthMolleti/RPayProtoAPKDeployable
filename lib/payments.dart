...
import 'package:test/utils/dateFunctions.dart';
              ...
              return GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      CircleAvatar(
                        backgroundColor:Colors.primaries[Random().nextInt(Colors.primaries.length)][Random().nextInt(9) * 100]?.withOpacity(Random().nextInt(7)/10+(0.2)),
                        radius: 25.r,
                        child: Text(
